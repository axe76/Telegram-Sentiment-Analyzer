...
def preprocess_train_data():
    ...
    train = pd.read_csv(r"C:\Users\ACER\Desktop\AI\Sentiment Analyzer\train.csv")
    test = pd.read_csv(r"C:\Users\ACER\Desktop\AI\Sentiment Analyzer\test.csv")
...
def embedding_weights(tokenizer):
    max_words = 20000
    embed_size = 50
    embedding_indices = dict(get_coefs(*o.strip().split()) for o in open(r"C:\Users\ACER\Desktop\AI\Sentiment Analyzer\glove.6B.50d.txt",encoding = "utf8"))
